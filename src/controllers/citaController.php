...
class CitaController
{
    ...
    public function getMisCitasPeluquera($id_peluquera)
    {
        $stmt = $this->model->getCitasByPeluqueraFull($id_peluquera);
        $citas = $stmt->fetchAll(PDO::FETCH_ASSOC);
        echo json_encode(["success" => true, "data" => $citas]);
    }
    ...
    public function getAllMascotasActivas()
    {
        $mascotas = $this->model->getAllMascotasActivas();
    ...
    public function updateEstado($id, $data)
    {
        ...
        echo json_encode([
            "success" => $ok,
            "message" => $ok ? "Estado actualizado correctamente" : "Error al actualizar"
        ]);
    }
    ...
    public function delete($id)
    {
        ...
        echo json_encode([
            "success" => $ok,
            "message" => $ok ? "Cita eliminada correctamente" : "Error al eliminar"
        ]);
    }
}